...
namespace FS20.Controllers
{
    public class SeasonsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SeasonID,Name,DateFrom,DateTo")] Season season)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SeasonID,Name,DateFrom,DateTo")] Season season)
        {
